...
function applyFilters(data) {
    ...
    return data.filter(item => {
        ...
        if (GlobalFilter.sdrId !== 'all') {
            ...
            // Se filtro ativo mas item sem ID, descarta (exceto no fallback)
...
function renderExecutiveView() {
    ...
    // Se filtramos por SDR e o resultado foi zero (dataset burnup sem ID), usa dataset Canais
    ...
    // Atualiza Badges (Remove carregando)
...
// ... Resto das funções (renderFunnelData, etc) mantidas iguais ...
